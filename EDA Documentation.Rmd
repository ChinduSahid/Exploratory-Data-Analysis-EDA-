...
```
From the plot we can see that the most popular Accom.type for holiday type A is either grade 2 or grade 1. People who book this holiday type has a high probability of needing an accommodation, this conclusion was derieved as there are no enquiries which requested for no accommodation for holiday type A. People who are booking any other holiday types might not need an accommodation, expecially those booking holiday type E.